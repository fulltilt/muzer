...
export default async function Home() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900">
      <Appbar />
      <main className="flex justify-center py-12 md:py-24 lg:py-32">
      ...
      <section className="flex justify-center w-full bg-gray-800 bg-opacity-50 py-12 md:py-24 lg:py-32">
        <div className="container px-4 md:px-6">
